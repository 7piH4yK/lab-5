...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        final GetTopGradeUseCase topGradeUseCase = config.getTopGradeCase();
        ...
        SwingUtilities.invokeLater(() -> {
            ...
            final JPanel manageTeamCard = createManageTeamCard(frame, leaveTeamUseCase, getAverageGradeUseCase, topGradeUseCase);
